...
namespace CSV_import_export
{
	public partial class frmExport : Form
	{
		...
		private void loadTables()
		{
            ...
            SqlConnection cn = new SqlConnection(prop.sqlConnExportString);
		...
		private void exportToCSV()
		{
            ...
            //lblstatus.Text = this.lbxTables.SelectedItem.ToString();
            saveFileDialogCSV.FileName = this.lbxTables.SelectedItem.ToString()+".csv";
		...
		private void exportToCSVfile(string fileOut)
		{
            ...
            SqlConnection conn = new SqlConnection(prop.sqlConnExportString);
			string sqlQuery = "select * from " + "["+this.lbxTables.SelectedItem.ToString()+"]";
			SqlCommand command = new SqlCommand(sqlQuery, conn);
            //lblstatus.Text = sqlQuery;
            conn.Open();
            try
            {
