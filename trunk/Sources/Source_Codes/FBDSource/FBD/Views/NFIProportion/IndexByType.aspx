...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	NFI Proportion By Business Types
</asp:Content>
    ...
    <table>
        <tr>
            <% using (Html.BeginForm())
                { %>
            <td>
                <%= Html.Label("Choose a business type") %>
            </td>
        
            <td>                
                <%= Html.DropDownList("Type", new SelectList(Model.Types as IEnumerable, "TypeID", "TypeName", 
                                                            Model.TypeID), new { onchange = "this.form.submit();" })%>
            </td>
            <% } %>    
        </tr>
