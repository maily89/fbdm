...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% Html.RenderPartial("DetailStep", FBD.CommonUtilities.Constants.BusinessRankStep.Financial); %>
    <hr />
	...
	<table>
	<tr>
	<td><input type="button" value="EDIT THIS INFORMATION" onclick="window.location.href='<%= Url.Action("AddFinancialScore", new { id = ViewData["RankID"], Edit="Edit" } ) %>';"/></td>
