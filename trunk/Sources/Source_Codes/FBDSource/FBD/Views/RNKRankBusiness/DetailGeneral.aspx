...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<table width="100%">
		<tr>
		<td valign="top">
			<b>Reporting period: <span class="brownText"><%=Model.BusinessRanking.SystemReportingPeriods.PeriodName %></span></b><br/>
			...
			<b>Industry: <span class="brownText"><%=Model.BusinessRanking.BusinessIndustries.IndustryName  %></span></b><br/>
			<b>Business type: <span class="brownText"><%=Model.BusinessRanking.BusinessTypes.TypeName  %></span></b><br/>
			<b>Tax code: <span class="brownText"><%=Model.BusinessRanking.TaxCode  %></span></b><br/>
			<b>Customer Type: <span class="brownText"><%=Model.BusinessRanking.SystemCustomerTypes.TypeName  %></span></b><br/>
		...
		<td valign="top">
			<b>Loan term: <span class="brownText"><%=Model.BusinessRanking.CustomersLoanTerm.LoanTermName %></span></b><br/>
			...
			<b>Scale: <span class="brownText"><%=Model.BusinessRanking.BusinessScales.Scale %></span></b><br/>
