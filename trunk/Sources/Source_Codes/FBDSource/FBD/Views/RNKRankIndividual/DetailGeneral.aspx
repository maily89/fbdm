...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<table width="100%">
		...
		<td valign="top">
			<b>Loan term: <span class="brownText"><%=Model.IndividualRanking.CustomersLoanTerm.LoanTermName %></span></b><br/>
			...
			<b>Collateral Score: <span class="brownText"><%=Model.IndividualRanking.CollateralIndexScore%></span></b><br/>
